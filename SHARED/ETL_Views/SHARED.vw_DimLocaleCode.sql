...
go
    ...
    DROP TABLE IF EXISTS SLDS_RPT.SHARED.tblDimLocaleCode
    SELECT * INTO SLDS_RPT.SHARED.tblDimLocaleCode FROM SLDS_ETL.SHARED.vw_DimLocaleCode
    CREATE CLUSTERED COLUMNSTORE INDEX IX_LOCALE ON  SLDS_RPT.SHARED.tblDimLocaleCode